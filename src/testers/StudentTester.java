...
public class StudentTester {
	...
	public class StudentTests {
		...
		public class BallotTests{
			...
			//this is an extra test case i added
			@Test
			@DisplayName("extraTests")
			public void extraTest() {
				...
				candidates.add(new Candidate("9,Jimmy Neutron"));
				candidates.add(new Candidate("10,Luz Noceda"));
				Ballot ballot = new Ballot("15,4:1,3:2,1:3,2:4,5:7", candidates);
	
				ballot.eliminate(6);
				assertAll(
					() -> assertTrue(ballot.getBallotType() == 2,"this should be invalid")
						);
		...
		public class ElectionTests {
			...
			public void testConstructor4() {
				Election election = new Election("candidates.csv", "testb.csv");
				
				assertAll(
					    //() -> assertTrue(election.getListOfList().size() == 5,"Didn't count correct amount of ballots"),

						// () -> assertTrue(election.getListOfList().get(0).size() == 1,"Didn't count correct amount of ballots"),
						// () -> assertTrue(election.getListOfList().get(1).size() == 2,"Didn't count correct amount of ballots"),
						// () -> assertTrue(election.getListOfList().get(2).size() == 3,"Didn't count correct amount of ballots"),
						// () -> assertTrue(election.getListOfList().get(3).size() == 4,"Didn't count correct amount of ballots"),
						// () -> assertTrue(election.getListOfList().get(4).size() == 5,"Didn't count correct amount of ballots"),

						// () -> assertTrue(election.getTotalBallots() == 10,"Didn't count correct amount of ballots"),
						...
						// () -> assertTrue(election.getTotalValidBallots() == 10, "Didn't")
